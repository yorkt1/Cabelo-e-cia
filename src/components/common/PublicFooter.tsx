      ...
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
        <div className="col-span-2">
          <div className="flex items-center gap-2.5">
            <div className="size-8 rounded-lg bg-gradient-to-br from-primary to-accent flex items-center justify-center text-primary-foreground font-display font-semibold text-sm">B</div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-muted-foreground">
            ...
            <li><Link to="/agendar" className="hover:text-foreground">Agendar</Link></li>
          </ul>
        </div>
        <div>
