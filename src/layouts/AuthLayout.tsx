    ...
    <div className="min-h-screen w-full grid lg:grid-cols-2 bg-background">
      <div className="hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-primary/30 via-accent/40 to-secondary relative overflow-hidden">
        ...
        <Link to="/" className="flex items-center gap-3 relative z-10">
          <img src="/logo_cia.png" alt="Cabelos e Cia" className="h-12 w-auto rounded-lg object-contain" />
          <span className="font-display text-2xl font-bold tracking-tight text-foreground">Cabelos e Cia</span>
        </Link>
